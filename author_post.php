...
{
    $name_of_author=$_GET['name'];


  ?>
            <h1 class="page-header">
                All posts by <?php echo $name_of_author; ?>
            ...
            <?php
            $querry = " select * from posts where post_status='PUBLISHED' and post_aurthor='$name_of_author';  ";
