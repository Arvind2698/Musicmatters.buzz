<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <ul class="nav navbar-right top-nav">
        ...
        <!-- end of user settings drop down -->
        ...
        <ul class="nav navbar-nav side-nav">
            ...
            <li>
                ...
                <ul id="posts" class="collapse">
                    ...
                    <li>
                        <a href="all_post_add.php">Add Posts</a>
                    </li>
                    <li>
                        <a href="all_post_draft.php">Draft Posts</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="category.php"><i class="fa fa-fw fa-wrench"></i> Catigories</a>
            </li>
            <li >
